...
namespace TarefaApi.Migrations
{
    ...
    [Migration("20230322203302_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TarefaApi.Status", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TarefaApi.Tarefa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TarefaApi.TarefaTipo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TarefaApi.Tarefa", b =>
                {
                    b.HasOne("TarefaApi.TarefaTipo", "TarefaTipo")
                        .WithMany()
